...
outputFolder = 'Data_set_no_EEG_step_0.5_3PCA_3x20_intact';
mkdir(outputFolder)
...
for number_measureNum = 1 : length_measureNumList
    ...
    parfor sample_num = 1:num_samples_per_subject
        ...
        for electrodeNum = 1:125
            ...
            w1 = measureTimeSeriesFromEEG{subjectNum}{dataSetNum}{electrodeNum}{:, measureNum}(n + 2); %%%!!! step size, not the stride
...
%                 
%                 
                first_stimulus_window_num = first_stimulus_window_num + stimulus_window_hop_size * 1; %%%!!! stride is 0.5s
                last_music_window_num = first_stimulus_window_num + stimulus_window_size - 1;
